...
Reference https://github.com/fossasia/kniteditor/blob/master/kniteditor/localization/__init__.py
...
_locale_dir = abspath('./locales')
_current_language = None
_locales = None
DOMAIN = "svgui"  #: the name of the .po files
